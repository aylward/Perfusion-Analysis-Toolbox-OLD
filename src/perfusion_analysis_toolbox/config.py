...
def parse_config():
    ...
    parser.add_argument('--save-path', type=str, required=True, help='Path to folder to save results')
    parser.add_argument('--vessel-path', type=str, required=True, help='Path to vessel centerlines input file')
    ...
    parser.add_argument('--use_filter', type = bool, default = True,
                        help = 'Whether use low-pass filtering for CTC. Usually need filter for MRP, no need for CTP.')
    ...
    parser.add_argument('--mask', type = list, default = [[], [0,138], [0,138]],
